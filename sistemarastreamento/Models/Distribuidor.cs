...
namespace sistemarastreamento.Models
{
    public class Distribuidor
    {
        ...
        public Distribuidor(string cnpj, string nome, string ie, string representante, string rua, int numero, string bairro, string telefone, string email, string senha, int estado, int cidade)
        {
            _cnpj = cnpj;
            _nome = nome;
            _ie = ie;
